            ...
            <div className={cx('detail-content')}>
                <div className={cx('content-price')}>
                    ...
                    <div className={cx('content-text')}>
                        <p>
                            Lil Pudgys is a collection of 22,222 NFTs originating from Pudgy Penguins. Don’t let their
                            small stature fool you, Lil Pudgys are an integral piece of the Pudgy Penguins history.
                            Their story began during the most frigid of winters. In the midst of adversity, the birth of
                            the Lil Pudgys helped spark new-life into the Pudgy Penguins community.{' '}
                        </p>
