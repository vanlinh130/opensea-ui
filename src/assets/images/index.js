const images = {
    ...
    slide_4: require('~/assets/images/list-table/slide-4.avif'),

    table_1: require('~/assets/images/table-1.avif'),
    collection_1: require('~/assets/images/collection-1.webp'),
    collector_1: require('~/assets/images/collector-1.avif'),
    nft_1: require('~/assets/images/nft-1.webp'),
    category_1: require('~/assets/images/category-1.webp'),
